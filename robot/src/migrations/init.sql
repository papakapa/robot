...
DELETE FROM execution_statuses;
DELETE FROM link_types;

INSERT INTO execution_statuses (status) VALUES ('fulfilled'),('rejected'), ('pending');
INSERT INTO link_types (type) VALUES ('wep-page'),('image');
INSERT INTO token_types (type) VALUES ('title'), ('text'), ('description'), ('keyword'), ('domain'), ('pathname');
